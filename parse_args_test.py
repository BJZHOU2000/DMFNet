...
def parse_args():
    ...
    #NUDT-SIRST_DNANet_10_11_2022_07_24_17_wDS
    #NUDT-SIRST_DNANet_27_12_2022_22_53_30_wDS  -all
    #NUDT-SIRST_DNANet_28_12_2022_13_36_39_wDS  -CSAM
    #NUDT-SIRST_DNANet_28_12_2022_21_58_36_wDS  -sa
    #NUDT-SIRST_DNANet_29_12_2022_11_00_14_wDS  -ca

    # data and pre-process
    parser.add_argument('--dataset', type=str, default='NUDT-SIRST',
                        help='dataset name: NUDT-SIRST, NUAA-SIRST, NUST-SIRST')
    parser.add_argument('--st_model', type=str, default='NUDT-SIRST_DNANet_09_08_2023_21_05_18_wDS',
                        help='NUDT-SIRST_DNANet_29_12_2022_11_00_14_wDS,'
                             'NUAA-SIRST_DNANet_28_07_2021_05_21_33_wDS')
    parser.add_argument('--model_dir', type=str,
                        default = 'NUDT-SIRST_DNANet_09_08_2023_21_05_18_wDS/mIoU__DNANet_NUDT-SIRST_epoch.pth.tar',
                        help    = 'NUDT-SIRST_DNANet_29_12_2022_11_00_14_wDS/mIoU__DNANet_NUDT-SIRST_epoch.pth.tar,'
